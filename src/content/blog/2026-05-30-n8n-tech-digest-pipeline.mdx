...
![n8n workflow canvas at the start of the build](/resources/attachments/n8n-canvas-start.png)
_Where it all started._

![n8n workflow running from trigger to Telegram delivery](/resources/attachments/workflow-run.gif)
...
![The digest arriving in my Telegram chat alongside my Samantha conversation](/resources/attachments/telegram-with-context.png)
